    ...
    <div className="relative">
      ...
      <div className="relative">
        <button
          ...
          className={`w-full px-3 py-2 text-left border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black ${
            ...
            {providers.map((provider) => (
              <button
                ...
                className={`w-full text-left px-3 py-2 hover:bg-gray-100 ${
                  value === provider.id ? 'bg-blue-50 text-blue-600' : 'text-black'
                }`}
              >
                {provider.name}
              </button>
